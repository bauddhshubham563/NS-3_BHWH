# NS-3_BHWH
AI-Based Routing Optimization under Blackhole and Wormhole Attack Scenario in MANET

Download all files
1. detect_and_mitigate.py --- Python code to detect malicious node and create banlist 
...
6. cleanup_Script.sh --- Script for removing all generated output files 
